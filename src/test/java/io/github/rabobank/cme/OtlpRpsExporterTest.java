...
class OtlpRpsExporterTest {
    ...
    void payloadContainsResourceAttributes() throws Exception {
        ...
        OtlpRpsExporter exp = new OtlpRpsExporter("http://example/v1/metrics", new FixedRps(42), ai, null);
        // When
        ...
        assertTrue(json.contains("cf.application_name"));
        assertTrue(json.contains("app-name"));
        assertTrue(json.contains("cf.space_name"));
        assertTrue(json.contains("space"));
        assertTrue(json.contains("cf.organization_name"));
        assertTrue(json.contains("org"));
        assertTrue(json.contains("cf.instance_index"));
